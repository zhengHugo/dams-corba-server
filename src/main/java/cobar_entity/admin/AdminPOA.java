...
/**
 * admin/AdminPOA.java . Generated by the IDL-to-Java compiler (portable), version "3.2" from
...
public abstract class AdminPOA extends org.omg.PortableServer.Servant
  ...
  static {
    ...
    _methods.put("listLocalAppointmentAvailability", new java.lang.Integer(3));
  }
  ...
  public org.omg.CORBA.portable.OutputStream _invoke(
    ...
    switch (__method.intValue()) {
      ...
      case 3: // admin/Admin/listLocalAppointmentAvailability
        {
          AppointmentTypeDto type = AppointmentTypeDtoHelper.read(in);
          String $result = null;
          $result = this.listLocalAppointmentAvailability(type);
          out = $rh.createReply();
          out.write_string($result);
          break;
        }
