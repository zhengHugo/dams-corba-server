...
/**
 * patient/PatientPOA.java . Generated by the IDL-to-Java compiler (portable), version "3.2" from
...
public abstract class PatientPOA extends org.omg.PortableServer.Servant
  ...
  public org.omg.CORBA.portable.OutputStream _invoke(
    ...
    switch (__method.intValue()) {
      ...
      case 5: // patient/Patient/swapAppointment
        {
          String patientId = in.read_string();
          ...
          boolean $result = false;
          $result =
              this.swapAppointment(patientId, oldType, oldAppointmentId, newType, newAppointmentId);
          out = $rh.createReply();
          out.write_boolean($result);
          break;
        }
  ...
  public Patient _this() {
    return PatientHelper.narrow(super._this_object());
  }

  public Patient _this(org.omg.CORBA.ORB orb) {
    return PatientHelper.narrow(super._this_object(orb));
  }
} // class PatientPOA
