...
public class _PatientStub extends org.omg.CORBA.portable.ObjectImpl implements Patient
{
  ...
  public boolean bookLocalAppointment (String patientId, AppointmentTypeDto type, String appointmentId)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public boolean cancelLocalAppointment (String patientId, AppointmentTypeDto type, String appointmentId)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("cancelLocalAppointment", true);
                $out.write_string (patientId);
                AppointmentTypeDtoHelper.write ($out, type);
                $out.write_string (appointmentId);
                $in = _invoke ($out);
                ...
                return cancelLocalAppointment (patientId, type, appointmentId        );
            } finally {
                _releaseReply ($in);
            }
