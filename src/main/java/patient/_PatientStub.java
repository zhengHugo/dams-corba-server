...
public class _PatientStub extends org.omg.CORBA.portable.ObjectImpl implements patient.Patient
{

  public boolean bookAppointment (String patientId, appointment.AppointmentType type, String appointmentId)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("bookAppointment", true);
                $out.write_string (patientId);
                appointment.AppointmentTypeHelper.write ($out, type);
  ...
  public boolean cancelAppointment (String patientId, appointment.AppointmentType type, String appointmentId)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public boolean swapAppointment (String patientId, appointment.AppointmentType oldType, String oldAppointmentId, appointment.AppointmentType newType, String newAppointmentId)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("swapAppointment", true);
                $out.write_string (patientId);
                appointment.AppointmentTypeHelper.write ($out, oldType);
                $out.write_string (oldAppointmentId);
                appointment.AppointmentTypeHelper.write ($out, newType);
