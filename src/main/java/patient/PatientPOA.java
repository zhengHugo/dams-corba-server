...
public abstract class PatientPOA extends org.omg.PortableServer.Servant
 implements patient.PatientOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       {
         String patientId = in.read_string ();
         appointment.AppointmentType oldType = appointment.AppointmentTypeHelper.read (in);
         String oldAppointmentId = in.read_string ();
         appointment.AppointmentType newType = appointment.AppointmentTypeHelper.read (in);
